...
class Filter extends Base
{
    ...
    public function date_range2($title = '', $field = '',$value = array())
    {
        $field_start ='start_'.$field;
        $field_end = 'end_'.$field;
        ...
        $html .= '<label class="form-label col-xs-2 col-sm-2">' . $title_0 . '：</label>';
        $html .= '<div class="col-xs-4 col-sm-4">';
        $html .= '<input type="text" name="' . $field_start . '" id="' . $field_start . '" class="input-text Wdate" value="' . $start . '"';
        $html .= ' onfocus="WdatePicker({ maxDate:\'#F{ $dp.$D(\\\'' . $field_end . '\\\')}\', dateFmt:\'yyyy-MM-dd HH:mm:00\' })">';
        $html .= '</div>';
        $html .= '<label class="form-label col-xs-1 col-sm-1">' . $title_1 . '：</label>';
        $html .= '<div class="col-xs-4 col-sm-4">';
        $html .= '<input type="text" name="' . $field_end . '" id="' . $field_end . '" class="input-text Wdate" value="' . $end . '"';
        $html .= ' onfocus="WdatePicker({ minDate:\'#F{ $dp.$D(\\\'' . $field_start . '\\\')}\', dateFmt:\'yyyy-MM-dd HH:mm:00\' })">';
        $html .= '</div>';
        $html .= '</div>';
        return $html;
    }
